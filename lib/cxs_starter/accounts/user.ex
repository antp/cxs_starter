defmodule CxsStarter.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, CxsStarter.Repo)
  ...
  defp validate_password(changeset, opts) do
    ...
    |> validate_length(:password, min: 12, max: 180)
  ...
  """
  def valid_password?(%CxsStarter.Accounts.User{hashed_password: hashed_password}, password)
