defmodule Bamboo.EEx do
  defmacro __using__(opts) do
    quote do
      ...
      """
      @spec render_to_html(Bamboo.Email.t(), String.t(), map | list, Keyword.t()) ::
              Bamboo.Email.t()
      ...
      """
      @spec render_to_text(Bamboo.Email.t(), String.t(), map | list, Keyword.t()) ::
              Bamboo.Email.t()
      ...
      defp path_to_template(_root, _template),
        do: raise(ArgumentError, message: "Bamboo.EEx expects :path to be a string")
